...
```
export LCM_DEFAULT_URL=udpm://239.255.76.99:7699?ttl=255
```
...
# gRpc接口使用方法
## 注意：本代码统一采用 **grpc v1.65.4**
## python环境配置
### 创建虚拟环境
```
conda create --name droid-gym python=3.10
...
pip install mujoco -i https://pypi.doubanio.com/simple
pip install mujoco-python-viewer -i https://pypi.doubanio.com/simple
```
安装gRpc
```
pip install -i https://pypi.doubanio.com/simple protobuf==5.28.0
pip install -i https://pypi.doubanio.com/simple grpcio==1.65.4
pip install -i https://pypi.doubanio.com/simple grpcio-tools==1.65.4
pip install -i https://pypi.doubanio.com/simple foxglove-websocket foxglove-schemas-protobuf
```
## python接口生成方法
```
python -m grpc_tools.protoc --python_out=. --pyi_out=. --grpc_python_out=. -I. ./*.proto
```