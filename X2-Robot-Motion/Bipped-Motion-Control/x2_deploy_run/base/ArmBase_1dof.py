...
class ArmBase:
    def __init__(self, _cfg):
        ...
        self.action_lib = load_action_sequences(script_dir + "/arm_action_lib/1dof")
        self.time_cnt = 0
        self.dancing = "none"
    ...
    def walk_arm_swing(self, legState):
        ...
        arm_hip_left = -hip_pos_error + self.action_lib["init"][0][0]
        arm_hip_right =  hip_pos_error + self.action_lib["init"][0][1]
        self.armCommand.position[0] = arm_hip_left
        self.armCommand.position[1] = arm_hip_right
