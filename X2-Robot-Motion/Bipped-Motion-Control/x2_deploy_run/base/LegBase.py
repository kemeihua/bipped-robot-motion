...
class LegBase:
    def __init__(self, _cfg):
        ...
        set_joint_mode(self.legCommand,self.legActions,self.cfg)
    ...
    def testLeg(self):
        ...
        D2R = math.pi / 180.0
        # 填充 dt1 和 dt2 列表
        dt1 = [0, 0, 45 * D2R, -90 * D2R, 45 * D2R, 0, 0, 45 * D2R, -90 * D2R, 45 * D2R]
        dt2 = [0, 0, 10 * D2R, -20 * D2R, 10 * D2R, 0, 0, 10 * D2R, -20 * D2R, 10 * D2R]
